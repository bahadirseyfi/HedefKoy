...
//  goalpost-app
//
//  Created by bahadir on 30.08.2020.
...
extension GoalsVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "goalSell") as? GoalSell else {return UITableViewCell() }
    ...
    func tableView(_ tableView: UITableView, editActionsForRowAt indexPath: IndexPath) -> [UITableViewRowAction]? {
        ...
        let addAction = UITableViewRowAction(style: .normal, title: "1 Ekle ") { (rowAction,indexPath ) in
